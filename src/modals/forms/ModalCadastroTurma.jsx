      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-200 flex flex-col max-h-[80vh]">
        ...
        <div className="overflow-y-auto custom-scrollbar p-6 space-y-5">
          ...
          <div>
            ...
            <input 
              type="text" 
              className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 outline-none transition-all"
            />
          </div>
          ...
          <div>
            ...
            <input type="text" className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:border-blue-600 outline-none" />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input type="text" className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:border-blue-600 outline-none" />
              <HiOutlineCalendar className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400" size={20} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <select className="w-full px-4 py-2.5 border border-gray-300 rounded-xl appearance-none bg-white focus:border-blue-600 outline-none">
                <option value=""></option>
